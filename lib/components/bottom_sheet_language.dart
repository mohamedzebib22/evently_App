      ...
      children: [
        Container(
          ...
          child: InkWell(
            ...
            child: languageProvider.appLanguage == 'en' ? getSelectedItem(S.of(context).English) : getUnSelectedItem(S.of(context).English)
          ),
        ),
        InkWell(
          onTap: (){
          ...
          child: Container(
            margin: EdgeInsets.all(16),
            child: languageProvider.appLanguage == 'ar' ?  getSelectedItem(S.of(context).Arabic) : getUnSelectedItem(S.of(context).Arabic)
            ),
        ),
      ],
    );
